...
-- ============================================================
-- POWERDESIGNER FRIENDLY FOREIGN KEYS
-- ------------------------------------------------------------
-- PowerDesigner 15 doi khi khong nhan FK inline dang:
--   column_id BIGINT REFERENCES table(id)
-- Nen phan duoi khai bao lai FK bang ALTER TABLE de PD ve quan he.
-- File nay dung cho reverse engineering/ve ERD, khong nhat thiet dung de run DB that.
-- ============================================================

ALTER TABLE tutor_profiles
  ADD CONSTRAINT fk_tutor_profiles_account
  FOREIGN KEY (account_id) REFERENCES user_accounts(id);

ALTER TABLE tutor_qualifications
  ADD CONSTRAINT fk_tutor_qualifications_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE tutor_qualifications
  ADD CONSTRAINT fk_tutor_qualifications_reviewer
  FOREIGN KEY (reviewed_by_account_id) REFERENCES user_accounts(id);

ALTER TABLE tutor_subjects
  ADD CONSTRAINT fk_tutor_subjects_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE tutor_subjects
  ADD CONSTRAINT fk_tutor_subjects_subject
  FOREIGN KEY (subject_id) REFERENCES subjects(id);

ALTER TABLE tutor_subjects
  ADD CONSTRAINT fk_tutor_subjects_reviewer
  FOREIGN KEY (reviewed_by_account_id) REFERENCES user_accounts(id);

ALTER TABLE learning_needs
  ADD CONSTRAINT fk_learning_needs_student
  FOREIGN KEY (student_account_id) REFERENCES user_accounts(id);

ALTER TABLE learning_needs
  ADD CONSTRAINT fk_learning_needs_subject
  FOREIGN KEY (subject_id) REFERENCES subjects(id);

ALTER TABLE private_tutoring_requests
  ADD CONSTRAINT fk_private_requests_student
  FOREIGN KEY (student_account_id) REFERENCES user_accounts(id);

ALTER TABLE private_tutoring_requests
  ADD CONSTRAINT fk_private_requests_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE private_tutoring_requests
  ADD CONSTRAINT fk_private_requests_learning_need
  FOREIGN KEY (learning_need_id) REFERENCES learning_needs(id);

ALTER TABLE private_tutoring_requests
  ADD CONSTRAINT fk_private_requests_subject
  FOREIGN KEY (subject_id) REFERENCES subjects(id);

ALTER TABLE course_classes
  ADD CONSTRAINT fk_course_classes_subject
  FOREIGN KEY (subject_id) REFERENCES subjects(id);

ALTER TABLE course_classes
  ADD CONSTRAINT fk_course_classes_primary_tutor
  FOREIGN KEY (primary_tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE course_classes
  ADD CONSTRAINT fk_course_classes_creator
  FOREIGN KEY (created_by_account_id) REFERENCES user_accounts(id);

ALTER TABLE tutor_applications
  ADD CONSTRAINT fk_tutor_applications_class
  FOREIGN KEY (class_id) REFERENCES course_classes(id);

ALTER TABLE tutor_applications
  ADD CONSTRAINT fk_tutor_applications_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE tutor_applications
  ADD CONSTRAINT fk_tutor_applications_reviewer
  FOREIGN KEY (reviewed_by_account_id) REFERENCES user_accounts(id);

ALTER TABLE class_registrations
  ADD CONSTRAINT fk_class_registrations_class
  FOREIGN KEY (class_id) REFERENCES course_classes(id);

ALTER TABLE class_registrations
  ADD CONSTRAINT fk_class_registrations_student
  FOREIGN KEY (student_account_id) REFERENCES user_accounts(id);

ALTER TABLE class_registrations
  ADD CONSTRAINT fk_class_registrations_learning_need
  FOREIGN KEY (learning_need_id) REFERENCES learning_needs(id);

ALTER TABLE class_registrations
  ADD CONSTRAINT fk_class_registrations_reviewer
  FOREIGN KEY (reviewed_by_account_id) REFERENCES user_accounts(id);

ALTER TABLE tutor_availabilities
  ADD CONSTRAINT fk_tutor_availabilities_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE schedule_patterns
  ADD CONSTRAINT fk_schedule_patterns_private_request
  FOREIGN KEY (private_request_id) REFERENCES private_tutoring_requests(id);

ALTER TABLE schedule_patterns
  ADD CONSTRAINT fk_schedule_patterns_class
  FOREIGN KEY (class_id) REFERENCES course_classes(id);

ALTER TABLE learning_sessions
  ADD CONSTRAINT fk_learning_sessions_private_request
  FOREIGN KEY (private_request_id) REFERENCES private_tutoring_requests(id);

ALTER TABLE learning_sessions
  ADD CONSTRAINT fk_learning_sessions_class
  FOREIGN KEY (class_id) REFERENCES course_classes(id);

ALTER TABLE learning_sessions
  ADD CONSTRAINT fk_learning_sessions_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE schedule_blocks
  ADD CONSTRAINT fk_schedule_blocks_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE schedule_blocks
  ADD CONSTRAINT fk_schedule_blocks_private_request
  FOREIGN KEY (private_request_id) REFERENCES private_tutoring_requests(id);

ALTER TABLE schedule_blocks
  ADD CONSTRAINT fk_schedule_blocks_class
  FOREIGN KEY (class_id) REFERENCES course_classes(id);

ALTER TABLE teaching_contracts
  ADD CONSTRAINT fk_teaching_contracts_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE teaching_contracts
  ADD CONSTRAINT fk_teaching_contracts_private_request
  FOREIGN KEY (private_request_id) REFERENCES private_tutoring_requests(id);

ALTER TABLE teaching_contracts
  ADD CONSTRAINT fk_teaching_contracts_class
  FOREIGN KEY (class_id) REFERENCES course_classes(id);
...
ALTER TABLE payments
  ...
  FOREIGN KEY (contract_id) REFERENCES teaching_contracts(id);
...
ALTER TABLE reviews
  ADD CONSTRAINT fk_reviews_tutor
  FOREIGN KEY (tutor_id) REFERENCES tutor_profiles(id);

ALTER TABLE recommendation_events
  ADD CONSTRAINT fk_recommendation_events_student
  FOREIGN KEY (student_account_id) REFERENCES user_accounts(id);

ALTER TABLE recommendation_events
  ADD CONSTRAINT fk_recommendation_events_learning_need
  FOREIGN KEY (learning_need_id) REFERENCES learning_needs(id);

ALTER TABLE learning_need_schedules
  ADD CONSTRAINT fk_learning_need_schedules_need
  FOREIGN KEY (learning_need_id) REFERENCES learning_needs(id) ON DELETE CASCADE;

ALTER TABLE message_threads
  ADD CONSTRAINT fk_message_threads_private_request
  FOREIGN KEY (private_request_id) REFERENCES private_tutoring_requests(id);

ALTER TABLE message_threads
  ADD CONSTRAINT fk_message_threads_class
  FOREIGN KEY (class_id) REFERENCES course_classes(id);

ALTER TABLE message_threads
  ADD CONSTRAINT fk_message_threads_class_registration
  FOREIGN KEY (class_registration_id) REFERENCES class_registrations(id);

ALTER TABLE message_thread_participants
  ADD CONSTRAINT fk_message_thread_participants_thread
  FOREIGN KEY (thread_id) REFERENCES message_threads(id) ON DELETE CASCADE;

ALTER TABLE message_thread_participants
  ADD CONSTRAINT fk_message_thread_participants_account
  FOREIGN KEY (account_id) REFERENCES user_accounts(id);
